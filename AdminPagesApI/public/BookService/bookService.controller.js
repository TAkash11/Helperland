                ...
                return this.bookService
                    ...
                    if (request) {
                        return this.bookService
                            ...
                            if (helper.length > 0) {
                                const hp = yield this.bookService.removeHelperBlockedLoginCustomer(parseInt(req.body.UserId), helper);
                                return this.bookService.getBlockedHelper(parseInt(req.body.UserId), hp)
                                    ...
                                    if (blockedHelper) {
                                        ...
                                        const users = yield this.bookService.removeBlockedHelper(hp, blockedHelper);
