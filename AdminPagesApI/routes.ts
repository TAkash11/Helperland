...
router.put("/helperland/BlockCustomer/:userId", loginController.validateToken, celebrate(Blocked), blockCustomerController.addCustomerInBlockList);
...
router.put("/helperland/UpdateMyDetails", celebrate(UpdateUser), loginController.validateToken, mySettingsController.updateUserDetailById);
...
router.post('/helperland/reschedule/:ServiceId', celebrate(RescheduleAdd), loginController.validateToken, servicemanagementcontroller.rescheduleIfTimeSlotNotConflicts, servicemanagementcontroller.RescheduleWithAddress);
