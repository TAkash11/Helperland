                                                ...
                                                if(service.ServiceProviderId) {
                                                    ...
                                                    return this.dashboardService
                                                      ...
                                                      .then(async (serviceReq) => {
                                                          if(serviceReq) {
                                                              const { startDate,  isMatch, startTime, endTime } = await this.dashboardService.SPHasFutureSameDateTime (req.body.ServiceStartDate, serviceReq, req.body.totalHour, req.body.ServiceStartTime);
                                                                  if(isMatch) {
