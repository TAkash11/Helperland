...
const { addPassword } = forgotPassword_model_1.ResetSchema;
 ...
 */
router.post('/helperland/CreateRequest', (0, celebrate_1.celebrate)(CreateService), loginController.validateToken, bookServiceController.decodeToken, bookServiceController.CreateService);
