...
exports.ForgottController = void 0;
...
var saltRounds = 10;
var ForgottController = /** @class */ (function () {
    function ForgottController(forgotService) {
        var _this = this;
        ...
        this.forgotPassword = function (req, res) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                if (Email) {
                    return [2 /*return*/, this.forgotService
                            ...
                            var resetLink = _this.forgotService.createToken(User.UserId);
                            var data = _this.forgotService.createData(User.Email, resetLink);
    ...
    return ForgottController;
}());
exports.ForgottController = ForgottController;
