...
class ServiceManagementRepository {
    ...
    findByServiceId(ServiceRequestId) {
        return __awaiter(this, void 0, void 0, function* () {
    ...
    updateServiceStatus(ServiceRequestId) {
        return __awaiter(this, void 0, void 0, function* () {
            return index_1.db.ServiceRequest.update({ Status: 3 }, { where: { ServiceRequestId: ServiceRequestId } });
        });
    }
